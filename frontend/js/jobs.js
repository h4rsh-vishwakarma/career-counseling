async function fetchJobs() {
    ...
    try {
        const response = await fetch(`https://career-counseling-backend.onrender.com/api/jobs?skills=${skills}&qualification=${qualification}&stream=${stream}&location=${location}`);
...
async function fetchJobs() {
    ...
    try {
        const response = await fetch(`https://career-counseling-backend.onrender.com/api/jobs?skills=Software&qualification=${qualification}&stream=${stream}&location=India`);
        const jobs = await response.json();

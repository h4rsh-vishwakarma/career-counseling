document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        const response = await fetch("https://career-counseling.onrender.com/api/mentorship/mentors", {
        ...
        try {
            ...
            document.querySelectorAll(".join-session-btn").forEach(button => {
                button.addEventListener("click", async (event) => {
                    ...
                    const response = await fetch("https://career-counseling.onrender.com/api/mentorship/join-session", {
                        method: "POST",
...
async function loadAvailableSessions() {
    ...
    try {
        const response = await fetch("https://career-counseling.onrender.com/api/mentorship/available-sessions", {
            method: "GET",
...
async function requestMentorship(sessionId) {
    try {
        const response = await fetch(`https://career-counseling.onrender.com/api/mentorship/request`, {
            method: "POST",
            headers: { 
